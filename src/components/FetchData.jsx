...
const FetchData = ({cat}) => {
    ...
    const fetchdata = async()=>{
        await axios
        .get(
            cat ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=911c40e946e544de833b0b1adc86a0fd`:
            "https://newsapi.org/v2/top-headlines?country=in&apiKey=911c40e946e544de833b0b1adc86a0fd"
        )
